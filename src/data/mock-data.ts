import type { Group, Case, Match, Dataset, MatchStatus, RiskLevel, CheckType, EntityType, ChangeLogEntry, WhyMatchedField, MatchFieldResult, CaseNote, CaseAuditEvent, AuditEventType, AuditMatchDetail, AuditEventDetails, ResolutionHistoryEntry, PriorityLevel, MakerDecision, MakerType, NameMatchDetail, ListingProvenance } from '@/types';
...
const caseDefs: CaseDef[] = [
  ...
  // 1. High-risk sanctioned individual — all matches confirmed positive
  {
    ...
    matches: [
      { matchedName: 'Ahmed Al Rashid', aliases: ['Ahmed Al-Rasheed', 'A. Rashid'], strength: 95, dataset: 'Sanctions', status: 'Positive', riskLevel: 'High', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...
        nameMatchDetail: { matchedString: 'أحمد الراشد', isAlias: true, aliasValue: 'أحمد الراشد', similarity: 96, script: 'Arabic', transliterated: true, transposition: false },
        listingProvenance: { sanctioningBody: 'OFAC', programme: 'SDN — SDGT (Executive Order 13224)', listingDate: '2019-03-10', designationType: 'direct', note: 'Also listed by UN Security Council Consolidated List.' },
  ...
  // 2. Clean individual — all false matches
  {
    ...
    matches: [
      { matchedName: 'Yelena Volkova', aliases: ['E. Volkova'], strength: 68, dataset: 'Sanctions', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...
        nameMatchDetail: { matchedString: 'Елена Волкова', isAlias: true, aliasValue: 'Елена Волкова', similarity: 71, script: 'Cyrillic', transliterated: true, transposition: false },
        listingProvenance: { sanctioningBody: 'EU Council', programme: 'EU Regulation 269/2014 (Ukraine territorial integrity)', listingDate: '2022-05-18', designationType: 'ownership', ownershipChain: ['Gazprombank (directly listed)', 'RosNeftEnergo JSC (subsidiary)', 'Yelena Volkova (51% beneficial owner)'], note: 'Derivatively designated under EU equivalent of the OFAC 50% Rule.' },
  ...
  // 3. Under investigation — mixed unresolved + possible
  {
    ...
    matches: [
      // ── Unresolved: credible matches needing analyst decision ──
      ...
      { matchedName: 'Carlos Mendoza Reyes', aliases: ['C.A. Mendoza'], strength: 87, dataset: 'Sanctions', status: 'Unresolved', riskLevel: 'High', updated: true, reviewRequired: true, reviewRequiredReasons: ['Sanctions list updated', 'New source added'],
        ...wmIndividual('Carlos Mendoza', 'Carlos Mendoza Reyes', 87, { dobInput: '1970-03-14', dobMatch: '1970-03-14', dobResult: 'match', natInput: 'MX', natMatch: 'MX', natResult: 'match', countryInput: 'Mexico', countryMatch: 'Mexico', countryResult: 'match', idInput: 'P672184935', idMatch: '—', idResult: 'missing' }),
        identifiers: { dob: '1970-03-14', gender: 'Male', nationality: 'MX', country: 'Mexico' },
        recordData: { keyData: { 'Full Name': 'Carlos Mendoza Reyes', 'Date of Birth': '1970-03-14', 'Nationality': 'MX', 'Category': 'Sanctions', 'Listed Date': '2024-10-14', 'Last Updated': '2025-02-11' }, furtherInfo: 'Recently designated under OFAC Kingpin Act. Believed to be an alias / same individual as Carlos Alberto Mendoza Reyes.', aliases: ['C.A. Mendoza'], keywords: ['Drug Trafficking'], pepRoleDetails: undefined, connections: ['Sinaloa Financial Group SA (Business Partner)'], sources: [{ name: 'OFAC SDN List', url: '#' }] } },
      { matchedName: 'Carlos A. Mendoza', aliases: ['C.A. Mendoza-R.'], strength: 82, dataset: 'Law Enforcement', status: 'Unresolved', riskLevel: 'High', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'Carlos A. Mendoza', 82, { dobInput: '1970-03-14', dobMatch: '1970-03-14', dobResult: 'match', natInput: 'MX', natMatch: 'MX', natResult: 'match', countryInput: 'Mexico', countryMatch: 'United States', countryResult: 'mismatch' }),
        identifiers: { dob: '1970-03-14', gender: 'Male', nationality: 'MX', country: 'United States' },
        recordData: { keyData: { 'Full Name': 'Carlos A. Mendoza', 'Date of Birth': '1970-03-14', 'Nationality': 'MX', 'Category': 'Law Enforcement', 'Listed Date': '2019-05-30', 'Last Updated': '2024-12-04' }, furtherInfo: 'US federal indictment for narcotics conspiracy in Southern District of California. DOB and nationality consistent with screening subject; residence differs.', aliases: ['C.A. Mendoza-R.'], keywords: ['Drug Trafficking'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'US DOJ', url: '#' }] } },
      { matchedName: 'Carlos Mendoza R.', aliases: [], strength: 76, dataset: 'PEP', status: 'Unresolved', riskLevel: 'Medium', updated: true, reviewRequired: true, reviewRequiredReasons: ['Profile updated'],
        ...wmIndividual('Carlos Mendoza', 'Carlos Mendoza R.', 76, { dobInput: '1970-03-14', dobMatch: '1970-??-??', dobResult: 'partial', natInput: 'MX', natMatch: 'MX', natResult: 'match', countryInput: 'Mexico', countryMatch: 'Mexico', countryResult: 'match' }),
        identifiers: { dob: '1970-06-01', gender: 'Male', nationality: 'MX', country: 'Mexico' },
        recordData: { keyData: { 'Full Name': 'Carlos Mendoza Ramírez', 'Date of Birth': '1970-06-01', 'Nationality': 'MX', 'Category': 'PEP', 'Listed Date': '2022-01-11', 'Last Updated': '2025-01-05' }, furtherInfo: 'Municipal official in Sinaloa. Year of birth matches but full DOB unconfirmed by source.', aliases: [], keywords: ['Corruption'], pepRoleDetails: 'Municipal Treasurer, Culiacán', connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Carlos Mendoza Alberto', aliases: ['C.M. Alberto'], strength: 74, dataset: 'Law Enforcement', status: 'Unresolved', riskLevel: 'Medium', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'Carlos Mendoza Alberto', 74, { dobInput: '1970-03-14', dobMatch: '—', dobResult: 'missing', natInput: 'MX', natMatch: 'MX', natResult: 'match', countryInput: 'Mexico', countryMatch: 'Mexico', countryResult: 'match', idInput: 'P672184935', idMatch: '—', idResult: 'missing' }),
        identifiers: { gender: 'Male', nationality: 'MX', country: 'Mexico' },
        recordData: { keyData: { 'Full Name': 'Carlos Mendoza Alberto', 'Nationality': 'MX', 'Category': 'Law Enforcement', 'Listed Date': '2023-11-20', 'Last Updated': '2024-11-22' }, furtherInfo: 'Person of interest in cross-border money laundering investigation. DOB not disclosed by source; name tokens rearranged from primary target.', aliases: ['C.M. Alberto'], keywords: ['Money Laundering'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'FinCEN', url: '#' }] } },
      // ── False positives with clear distinguishing identifiers ──
      { matchedName: 'Carlos J. Mendoza', aliases: ['CJ Mendoza'], strength: 64, dataset: 'PEP', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...
        recordData: { keyData: { 'Full Name': 'Carlos Javier Mendoza', 'Date of Birth': '1972-08-19', 'Nationality': 'CO', 'Category': 'PEP', 'Listed Date': '2021-11-05', 'Last Updated': '2025-01-15' }, furtherInfo: 'Former Colombian congressman from Antioquia. Different DOB and nationality — cleared as false positive.', aliases: ['CJ Mendoza'], keywords: ['Corruption'], pepRoleDetails: 'Former Congressman, Antioquia Department, Colombia', connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'C. Mendoza García', aliases: [], strength: 46, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'C. Mendoza García', 46, { dobInput: '1970-03-14', dobMatch: '1985-02-11', dobResult: 'mismatch', natInput: 'MX', natMatch: 'ES', natResult: 'mismatch', countryInput: 'Mexico', countryMatch: 'Spain', countryResult: 'mismatch' }),
        identifiers: { dob: '1985-02-11', gender: 'Male', nationality: 'ES', country: 'Spain' },
        recordData: { keyData: { 'Full Name': 'Cristóbal Mendoza García', 'Date of Birth': '1985-02-11', 'Nationality': 'ES', 'Category': 'Other', 'Listed Date': '2023-06-12', 'Last Updated': '2024-03-01' }, furtherInfo: 'Spanish national named in Marbella tax investigation. Different DOB and nationality confirm distinct individual.', aliases: [], keywords: ['Tax Evasion'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'AEAT Spain', url: '#' }] } },
      { matchedName: 'Carlos Mendoza', aliases: [], strength: 59, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'Carlos Mendoza', 59, { dobInput: '1970-03-14', dobMatch: '1948-04-22', dobResult: 'mismatch', natInput: 'MX', natMatch: 'AR', natResult: 'mismatch', countryInput: 'Mexico', countryMatch: 'Argentina', countryResult: 'mismatch' }),
        identifiers: { dob: '1948-04-22', gender: 'Male', nationality: 'AR', country: 'Argentina' },
        recordData: { keyData: { 'Full Name': 'Carlos Mendoza', 'Date of Birth': '1948-04-22', 'Nationality': 'AR', 'Category': 'Other', 'Listed Date': '2015-02-14', 'Last Updated': '2022-08-10' }, furtherInfo: 'Retired Argentine footballer named in historical AFA misconduct records. Age gap of 22 years excludes screening subject.', aliases: [], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Carlos E. Mendoza', aliases: ['Charlie Mendoza'], strength: 51, dataset: 'Law Enforcement', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'Carlos E. Mendoza', 51, { dobInput: '1970-03-14', dobMatch: '1990-09-30', dobResult: 'mismatch', natInput: 'MX', natMatch: 'US', natResult: 'mismatch', countryInput: 'Mexico', countryMatch: 'United States', countryResult: 'mismatch', idInput: 'P672184935', idMatch: 'US-EA84726', idResult: 'mismatch' }),
        identifiers: { dob: '1990-09-30', gender: 'Male', nationality: 'US', country: 'United States' },
        recordData: { keyData: { 'Full Name': 'Carlos Eduardo Mendoza', 'Date of Birth': '1990-09-30', 'Nationality': 'US', 'Category': 'Law Enforcement', 'Listed Date': '2022-07-04', 'Last Updated': '2024-02-18' }, furtherInfo: 'US-citizen convicted of low-value wire fraud in Texas. 20-year age gap, different passport series.', aliases: ['Charlie Mendoza'], keywords: ['Fraud'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'US DOJ', url: '#' }] } },
      { matchedName: 'Carlo Mendoza', aliases: [], strength: 44, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'Carlo Mendoza', 44, { dobInput: '1970-03-14', dobMatch: '1979-11-08', dobResult: 'mismatch', natInput: 'MX', natMatch: 'IT', natResult: 'mismatch', countryInput: 'Mexico', countryMatch: 'Italy', countryResult: 'mismatch' }),
        identifiers: { dob: '1979-11-08', gender: 'Male', nationality: 'IT', country: 'Italy' },
        recordData: { keyData: { 'Full Name': 'Carlo Mendoza', 'Date of Birth': '1979-11-08', 'Nationality': 'IT', 'Category': 'Other', 'Listed Date': '2021-08-19', 'Last Updated': '2023-04-02' }, furtherInfo: 'Italian-Filipino national mentioned in Milan financial press. Different given name spelling, unrelated jurisdiction.', aliases: [], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'K. Mendoza', aliases: ['Carlos Mendoza-Perez'], strength: 38, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Carlos Mendoza', 'K. Mendoza', 38, { dobInput: '1970-03-14', dobMatch: '2001-01-15', dobResult: 'mismatch', natInput: 'MX', natMatch: 'PH', natResult: 'mismatch', countryInput: 'Mexico', countryMatch: 'Philippines', countryResult: 'mismatch' }),
        identifiers: { dob: '2001-01-15', gender: 'Male', nationality: 'PH', country: 'Philippines' },
        recordData: { keyData: { 'Full Name': 'Kevin Mendoza-Perez', 'Date of Birth': '2001-01-15', 'Nationality': 'PH', 'Category': 'Other', 'Listed Date': '2024-04-01', 'Last Updated': '2024-04-01' }, furtherInfo: 'Filipino national, minor cybercrime referral. Age and jurisdiction exclude screening subject.', aliases: ['Carlos Mendoza-Perez'], keywords: ['Cybercrime'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
    ],
  },
  // 4. PEP monitoring — low risk
  {
    ...
    matches: [
      { matchedName: 'Yuki Tanaka', aliases: ['田中 有希'], strength: 88, dataset: 'PEP', status: 'Possible', riskLevel: 'Low', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...
        nameMatchDetail: { matchedString: '田中 有希', isAlias: true, aliasValue: '田中 有希', similarity: 92, script: 'CJK', transliterated: true, transposition: false },
  ...
  // 9. Unassigned high-priority — needs attention
  {
    ...
    matches: [
      ...
      { matchedName: 'Mohammed Al Fayed', aliases: ['M. Fayed'], strength: 89, dataset: 'Sanctions', status: 'Unresolved', riskLevel: 'High', updated: true, reviewRequired: true, reviewRequiredReasons: ['New source added'],
        ...wmIndividual('Mohammed Al-Fayed', 'Mohammed Al Fayed', 89, { dobInput: '1968-02-11', dobMatch: '1968-02-11', dobResult: 'match', natInput: 'AE', natMatch: 'AE', natResult: 'match', countryInput: 'UAE', countryMatch: 'UAE', countryResult: 'match', idInput: 'N784129356', idMatch: '—', idResult: 'missing' }),
        identifiers: { dob: '1968-02-11', gender: 'Male', nationality: 'AE', country: 'UAE' },
        recordData: { keyData: { 'Full Name': 'Mohammed Al Fayed', 'Date of Birth': '1968-02-11', 'Nationality': 'AE', 'Category': 'Sanctions', 'Listed Date': '2024-09-04', 'Last Updated': '2025-02-12' }, furtherInfo: 'HM Treasury OFSI listing referencing UAE-resident individual involved in sanctions evasion networks. Likely same person as OFAC entry.', aliases: ['M. Fayed'], keywords: ['Money Laundering'], pepRoleDetails: undefined, connections: ['Al-Fayed Trading Group (Business Partner)'], sources: [{ name: 'UK Sanctions List', url: '#' }] } },
      { matchedName: 'Mohamed A. Al-Fayed', aliases: ['MAAF'], strength: 84, dataset: 'Law Enforcement', status: 'Unresolved', riskLevel: 'High', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Mohammed Al-Fayed', 'Mohamed A. Al-Fayed', 84, { dobInput: '1968-02-11', dobMatch: '1968-02-11', dobResult: 'match', natInput: 'AE', natMatch: 'AE', natResult: 'match', countryInput: 'UAE', countryMatch: 'UAE', countryResult: 'match' }),
        identifiers: { dob: '1968-02-11', gender: 'Male', nationality: 'AE', country: 'UAE' },
        recordData: { keyData: { 'Full Name': 'Mohamed Ahmed Al-Fayed', 'Date of Birth': '1968-02-11', 'Nationality': 'AE', 'Category': 'Law Enforcement', 'Listed Date': '2024-03-18', 'Last Updated': '2025-01-30' }, furtherInfo: 'Named in Dubai Public Prosecution filing related to fraudulent trade finance. DOB and nationality match — requires manual verification against source.', aliases: ['MAAF'], keywords: ['Fraud'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'UAE Public Prosecution', url: '#' }] } },
      { matchedName: 'Mohammed Al-Fayed', aliases: [], strength: 80, dataset: 'PEP', status: 'Unresolved', riskLevel: 'Medium', updated: true, reviewRequired: true, reviewRequiredReasons: ['Profile updated'],
        ...wmIndividual('Mohammed Al-Fayed', 'Mohammed Al-Fayed', 80, { dobInput: '1968-02-11', dobMatch: '1968-??-??', dobResult: 'partial', natInput: 'AE', natMatch: 'AE', natResult: 'match', countryInput: 'UAE', countryMatch: 'UAE', countryResult: 'match' }),
        identifiers: { dob: '1968-01-01', gender: 'Male', nationality: 'AE', country: 'UAE' },
        recordData: { keyData: { 'Full Name': 'Mohammed Al-Fayed', 'Date of Birth': '1968', 'Nationality': 'AE', 'Category': 'PEP', 'Listed Date': '2020-05-11', 'Last Updated': '2025-02-01' }, furtherInfo: 'Emirati businessman with ties to sovereign wealth advisory board. PEP by association; birth year only partially disclosed.', aliases: [], keywords: [], pepRoleDetails: 'Advisor, UAE Sovereign Investment Committee', connections: ['Al-Fayed Trading Group (Business Partner)'], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'M. Al-Fayed', aliases: ['Moe Fayed'], strength: 75, dataset: 'Law Enforcement', status: 'Unresolved', riskLevel: 'Medium', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Mohammed Al-Fayed', 'M. Al-Fayed', 75, { dobInput: '1968-02-11', dobMatch: '—', dobResult: 'missing', natInput: 'AE', natMatch: 'AE', natResult: 'match', countryInput: 'UAE', countryMatch: 'UAE', countryResult: 'match', idInput: 'N784129356', idMatch: '—', idResult: 'missing' }),
        identifiers: { gender: 'Male', nationality: 'AE', country: 'UAE' },
        recordData: { keyData: { 'Full Name': 'M. Al-Fayed', 'Nationality': 'AE', 'Category': 'Law Enforcement', 'Listed Date': '2024-11-01', 'Last Updated': '2024-12-20' }, furtherInfo: 'Person of interest in FIU suspicious activity report. Only initial and surname disclosed; nationality matches.', aliases: ['Moe Fayed'], keywords: ['Money Laundering'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'UAE FIU', url: '#' }] } },
      // ── False positives ──
      { matchedName: 'Mohammed Fayed Ali', aliases: [], strength: 52, dataset: 'Law Enforcement', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...
        recordData: { keyData: { 'Full Name': 'Mohammed Fayed Ali', 'Date of Birth': '1975-06-30', 'Nationality': 'EG', 'Category': 'Law Enforcement', 'Listed Date': '2021-04-22', 'Last Updated': '2024-07-01' }, furtherInfo: 'Egyptian national wanted for domestic financial crimes. DOB and nationality mismatch.', aliases: [], keywords: ['Fraud', 'Tax Evasion'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'Interpol', url: '#' }] } },
      { matchedName: 'Mohamed El Fayed', aliases: ['Al Fayed'], strength: 60, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Mohammed Al-Fayed', 'Mohamed El Fayed', 60, { dobInput: '1968-02-11', dobMatch: '1929-01-27', dobResult: 'mismatch', natInput: 'AE', natMatch: 'EG', natResult: 'mismatch', countryInput: 'UAE', countryMatch: 'United Kingdom', countryResult: 'mismatch' }),
        identifiers: { dob: '1929-01-27', gender: 'Male', nationality: 'EG', country: 'United Kingdom' },
        recordData: { keyData: { 'Full Name': 'Mohamed Al-Fayed (deceased)', 'Date of Birth': '1929-01-27', 'Nationality': 'EG', 'Category': 'Other', 'Listed Date': '2010-05-01', 'Last Updated': '2023-09-01' }, furtherInfo: 'Late Egyptian-British businessman, former owner of Harrods. Historical record; deceased 2023. Age gap of ~40 years excludes screening subject.', aliases: ['Al Fayed'], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Mahmoud Al-Fayed', aliases: [], strength: 48, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Mohammed Al-Fayed', 'Mahmoud Al-Fayed', 48, { dobInput: '1968-02-11', dobMatch: '1982-11-04', dobResult: 'mismatch', natInput: 'AE', natMatch: 'JO', natResult: 'mismatch', countryInput: 'UAE', countryMatch: 'Jordan', countryResult: 'mismatch' }),
        identifiers: { dob: '1982-11-04', gender: 'Male', nationality: 'JO', country: 'Jordan' },
        recordData: { keyData: { 'Full Name': 'Mahmoud Al-Fayed', 'Date of Birth': '1982-11-04', 'Nationality': 'JO', 'Category': 'Other', 'Listed Date': '2022-06-15', 'Last Updated': '2023-11-01' }, furtherInfo: 'Jordanian national mentioned in Amman commercial court records. Different given name and DOB.', aliases: [], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Muhammad Fayed', aliases: ['M. Fayed Jr.'], strength: 55, dataset: 'PEP', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Mohammed Al-Fayed', 'Muhammad Fayed', 55, { dobInput: '1968-02-11', dobMatch: '1995-08-19', dobResult: 'mismatch', natInput: 'AE', natMatch: 'PK', natResult: 'mismatch', countryInput: 'UAE', countryMatch: 'Pakistan', countryResult: 'mismatch' }),
        identifiers: { dob: '1995-08-19', gender: 'Male', nationality: 'PK', country: 'Pakistan' },
        recordData: { keyData: { 'Full Name': 'Muhammad Fayed', 'Date of Birth': '1995-08-19', 'Nationality': 'PK', 'Category': 'PEP', 'Listed Date': '2023-02-01', 'Last Updated': '2024-06-01' }, furtherInfo: 'Pakistani local government official. 27-year age gap; different nationality.', aliases: ['M. Fayed Jr.'], keywords: [], pepRoleDetails: 'District councillor, Lahore', connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Mohd. Al-Fayad', aliases: [], strength: 43, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Mohammed Al-Fayed', 'Mohd. Al-Fayad', 43, { dobInput: '1968-02-11', dobMatch: '1955-03-12', dobResult: 'mismatch', natInput: 'AE', natMatch: 'MY', natResult: 'mismatch', countryInput: 'UAE', countryMatch: 'Malaysia', countryResult: 'mismatch' }),
        identifiers: { dob: '1955-03-12', gender: 'Male', nationality: 'MY', country: 'Malaysia' },
        recordData: { keyData: { 'Full Name': 'Mohd. Al-Fayad', 'Date of Birth': '1955-03-12', 'Nationality': 'MY', 'Category': 'Other', 'Listed Date': '2020-01-05', 'Last Updated': '2022-04-11' }, furtherInfo: 'Malaysian former banker; spelling variant match only. Different DOB and jurisdiction.', aliases: [], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
    ],
  },
  ...
  // 14. Brazilian with many matches
  {
    ...
    matches: [
      // ── Unresolved: credible matches ──
      { matchedName: 'Roberto Carlos Silva', aliases: ['R. Silva', 'Roberto C. Silva'], strength: 88, dataset: 'Law Enforcement', status: 'Unresolved', riskLevel: 'High', updated: true, reviewRequired: true, reviewRequiredReasons: ['New source added', 'Profile updated', 'Category reclassified'],
        ...wmIndividual('Roberto Silva', 'Roberto Carlos Silva', 88, { dobInput: '1972-10-08', dobMatch: '1972-10-08', dobResult: 'match', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match', idInput: 'FX847261', idMatch: 'FX847261', idResult: 'match' }),
        identifiers: { dob: '1972-10-08', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Roberto Carlos Silva', 'Date of Birth': '1972-10-08', 'Nationality': 'BR', 'Category': 'Law Enforcement', 'Listed Date': '2020-08-12', 'Last Updated': '2025-01-28' }, furtherInfo: 'Subject of Polícia Federal investigation (Operation Lava Jato successor). Alleged bribery of state officials for public works contracts. All key identifiers match screening subject including passport.', aliases: ['R. Silva', 'Roberto C. Silva'], keywords: ['Corruption', 'Money Laundering'], pepRoleDetails: undefined, connections: ['Silva Construções SA (Business Partner)', 'Ana Silva (Family)'], sources: [{ name: 'Polícia Federal Brazil', url: '#' }, { name: 'COAF Brazil', url: '#' }] } },
      { matchedName: 'Roberto C. Silva', aliases: ['R.C. Silva'], strength: 82, dataset: 'Sanctions', status: 'Unresolved', riskLevel: 'High', updated: true, reviewRequired: true, reviewRequiredReasons: ['Sanctions list updated'],
        ...wmIndividual('Roberto Silva', 'Roberto C. Silva', 82, { dobInput: '1972-10-08', dobMatch: '1972-10-08', dobResult: 'match', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match' }),
        identifiers: { dob: '1972-10-08', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Roberto C. Silva', 'Date of Birth': '1972-10-08', 'Nationality': 'BR', 'Category': 'Sanctions', 'Listed Date': '2024-08-19', 'Last Updated': '2025-02-06' }, furtherInfo: 'Recently added to OFAC Global Magnitsky list for corruption. Believed to be same individual as Polícia Federal target.', aliases: ['R.C. Silva'], keywords: ['Corruption'], pepRoleDetails: undefined, connections: ['Silva Construções SA (Business Partner)'], sources: [{ name: 'OFAC SDN List', url: '#' }] } },
      { matchedName: 'Roberto Silva', aliases: ['R. Silva'], strength: 79, dataset: 'PEP', status: 'Unresolved', riskLevel: 'Medium', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'Roberto Silva', 79, { dobInput: '1972-10-08', dobMatch: '1972-10-08', dobResult: 'match', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match', idInput: 'FX847261', idMatch: '—', idResult: 'missing' }),
        identifiers: { dob: '1972-10-08', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Roberto Silva', 'Date of Birth': '1972-10-08', 'Nationality': 'BR', 'Category': 'PEP', 'Listed Date': '2019-06-01', 'Last Updated': '2024-12-11' }, furtherInfo: 'State-level PEP in Rio de Janeiro. DOB and nationality match screening subject. Passport not disclosed by source.', aliases: ['R. Silva'], keywords: [], pepRoleDetails: 'State Secretary of Infrastructure, Rio de Janeiro', connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Roberto Silva Santos', aliases: ['R. Silva Santos'], strength: 74, dataset: 'Law Enforcement', status: 'Unresolved', riskLevel: 'Medium', updated: true, reviewRequired: true, reviewRequiredReasons: ['Profile updated'],
        ...wmIndividual('Roberto Silva', 'Roberto Silva Santos', 74, { dobInput: '1972-10-08', dobMatch: '1972-??-??', dobResult: 'partial', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match' }),
        identifiers: { dob: '1972-05-20', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Roberto Silva Santos', 'Date of Birth': '1972-05-20', 'Nationality': 'BR', 'Category': 'Law Enforcement', 'Listed Date': '2023-04-08', 'Last Updated': '2025-01-11' }, furtherInfo: 'Named in São Paulo state prosecutor money laundering probe. Year of birth matches; full DOB differs by months.', aliases: ['R. Silva Santos'], keywords: ['Money Laundering'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'MPSP Brazil', url: '#' }] } },
      { matchedName: 'R. Silva', aliases: [], strength: 68, dataset: 'PEP', status: 'Unresolved', riskLevel: 'Medium', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'R. Silva', 68, { dobInput: '1972-10-08', dobMatch: '—', dobResult: 'missing', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match' }),
        identifiers: { gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'R. Silva', 'Nationality': 'BR', 'Category': 'PEP', 'Listed Date': '2022-09-14', 'Last Updated': '2024-08-01' }, furtherInfo: 'Municipal official in Minas Gerais with initials only in source. Nationality matches; DOB not disclosed.', aliases: [], keywords: [], pepRoleDetails: 'Municipal Secretary of Public Works', connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      // ── False positives ──
      { matchedName: 'Roberto Silva Junior', aliases: ['Beto Silva'], strength: 67, dataset: 'PEP', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...
        recordData: { keyData: { 'Full Name': 'Roberto Silva Junior', 'Date of Birth': '1998-12-01', 'Nationality': 'BR', 'Category': 'PEP', 'Listed Date': '2023-01-15', 'Last Updated': '2024-11-10' }, furtherInfo: 'Son of prominent Brazilian politician. PEP by association. 26-year age gap.', aliases: ['Beto Silva'], keywords: [], pepRoleDetails: 'PEP by association — son of Senator Roberto Silva Sr.', connections: ['Roberto Silva Sr. (Family)'], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'R. da Silva', aliases: ['Roberto da Silva'], strength: 41, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'R. da Silva', 41, { dobInput: '1972-10-08', dobMatch: '1955-07-04', dobResult: 'mismatch', natInput: 'BR', natMatch: 'PT', natResult: 'mismatch', countryInput: 'Brazil', countryMatch: 'Portugal', countryResult: 'mismatch' }),
        identifiers: { dob: '1955-07-04', gender: 'Male', nationality: 'PT', country: 'Portugal' },
        recordData: { keyData: { 'Full Name': 'Rogério da Silva', 'Date of Birth': '1955-07-04', 'Nationality': 'PT', 'Category': 'Other', 'Listed Date': '2019-05-20', 'Last Updated': '2023-01-15' }, furtherInfo: 'Portuguese national, historical tax issue. Different first name, DOB and nationality.', aliases: ['Roberto da Silva'], keywords: ['Tax Evasion'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Ricardo Silva', aliases: ['R. Silva'], strength: 56, dataset: 'Law Enforcement', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'Ricardo Silva', 56, { dobInput: '1972-10-08', dobMatch: '1988-03-22', dobResult: 'mismatch', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match' }),
        identifiers: { dob: '1988-03-22', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Ricardo Silva', 'Date of Birth': '1988-03-22', 'Nationality': 'BR', 'Category': 'Law Enforcement', 'Listed Date': '2024-02-10', 'Last Updated': '2024-11-05' }, furtherInfo: 'Different given name; 16-year age gap.', aliases: ['R. Silva'], keywords: ['Fraud'], pepRoleDetails: undefined, connections: [], sources: [{ name: 'Polícia Federal Brazil', url: '#' }] } },
      { matchedName: 'Roberto Silveira', aliases: [], strength: 50, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'Roberto Silveira', 50, { dobInput: '1972-10-08', dobMatch: '1965-11-30', dobResult: 'mismatch', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match' }),
        identifiers: { dob: '1965-11-30', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Roberto Silveira', 'Date of Birth': '1965-11-30', 'Nationality': 'BR', 'Category': 'Other', 'Listed Date': '2018-04-04', 'Last Updated': '2022-07-01' }, furtherInfo: 'Different surname (Silveira vs Silva); different DOB.', aliases: [], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Robert Silva', aliases: ['Bob Silva'], strength: 47, dataset: 'Other', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'Robert Silva', 47, { dobInput: '1972-10-08', dobMatch: '1980-06-14', dobResult: 'mismatch', natInput: 'BR', natMatch: 'US', natResult: 'mismatch', countryInput: 'Brazil', countryMatch: 'United States', countryResult: 'mismatch' }),
        identifiers: { dob: '1980-06-14', gender: 'Male', nationality: 'US', country: 'United States' },
        recordData: { keyData: { 'Full Name': 'Robert Silva', 'Date of Birth': '1980-06-14', 'Nationality': 'US', 'Category': 'Other', 'Listed Date': '2022-10-01', 'Last Updated': '2024-01-01' }, furtherInfo: 'US national mentioned in Florida civil forfeiture case. Different nationality and DOB.', aliases: ['Bob Silva'], keywords: [], pepRoleDetails: undefined, connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
      { matchedName: 'Roberto Silva Pereira', aliases: [], strength: 53, dataset: 'PEP', status: 'False', riskLevel: 'None', updated: false, reviewRequired: false, reviewRequiredReasons: [],
        ...wmIndividual('Roberto Silva', 'Roberto Silva Pereira', 53, { dobInput: '1972-10-08', dobMatch: '1949-02-28', dobResult: 'mismatch', natInput: 'BR', natMatch: 'BR', natResult: 'match', countryInput: 'Brazil', countryMatch: 'Brazil', countryResult: 'match' }),
        identifiers: { dob: '1949-02-28', gender: 'Male', nationality: 'BR', country: 'Brazil' },
        recordData: { keyData: { 'Full Name': 'Roberto Silva Pereira', 'Date of Birth': '1949-02-28', 'Nationality': 'BR', 'Category': 'PEP', 'Listed Date': '2010-09-01', 'Last Updated': '2023-05-11' }, furtherInfo: 'Retired federal judge. 23-year age gap excludes screening subject.', aliases: [], keywords: [], pepRoleDetails: 'Retired Federal Judge, TRF-1', connections: [], sources: [{ name: 'World-Check', url: '#' }] } },
    ],
  },
  ...
  // 17. Energy company — under investigation
  {
    ...
    matches: [
      { matchedName: 'Atlas Energy OOO', aliases: ['Atlas Energiya', 'АтласЭнергия'], strength: 83, dataset: 'Sanctions', status: 'Unresolved', riskLevel: 'High', updated: true, reviewRequired: true, reviewRequiredReasons: ['Sanctions list updated', 'New source added'],
        ...
        nameMatchDetail: { matchedString: 'АтласЭнергия', isAlias: true, aliasValue: 'АтласЭнергия', similarity: 84, script: 'Cyrillic', transliterated: true, transposition: false },
        listingProvenance: { sanctioningBody: 'OFAC', programme: 'Russia-related sanctions (Directive 4 / EO 14024)', listingDate: '2023-02-24', designationType: 'ownership', ownershipChain: ['Rosneft PJSC (directly listed under EO 14024)', 'Atlas Energy OOO (55% owned subsidiary)'], note: 'Blocked property under the OFAC 50% Rule via majority Rosneft ownership.' },
  ...
  // 30. Korean-Iranian connection — complex
  {
    ...
    matches: [
      { matchedName: 'Nikolai Sergeevich Sokolov', aliases: ['N. Sokolov', 'Николай Соколов'], strength: 88, dataset: 'Sanctions', status: 'Unresolved', riskLevel: 'High', updated: true, reviewRequired: true, reviewRequiredReasons: ['Sanctions list updated', 'New source added'],
        ...
        nameMatchDetail: { matchedString: 'Николай Сергеевич Соколов', isAlias: true, aliasValue: 'Николай Соколов', similarity: 94, script: 'Cyrillic', transliterated: true, transposition: false },
        listingProvenance: { sanctioningBody: 'EU Council', programme: 'EU Regulation 269/2014 (Ukraine territorial integrity)', listingDate: '2022-06-01', designationType: 'direct', note: 'Cross-listed by OFAC and UK OFSI.' },
